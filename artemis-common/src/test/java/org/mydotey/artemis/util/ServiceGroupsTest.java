...
public class ServiceGroupsTest {
    ...
    public void testFixWeight() {
        ...
        Assert.assertEquals(ServiceGroups.MIN_WEIGHT_VALUE + 1,
            ServiceGroups.fixWeight(ServiceGroups.MIN_WEIGHT_VALUE + 1));
        Assert.assertEquals(ServiceGroups.MAX_WEIGHT_VALUE - 1,
            ServiceGroups.fixWeight(ServiceGroups.MAX_WEIGHT_VALUE - 1));

        Assert.assertEquals(ServiceGroups.DEFAULT_WEIGHT_VALUE,
            ServiceGroups.fixWeight(ServiceGroups.MIN_WEIGHT_VALUE - 1));
        Assert.assertEquals(ServiceGroups.MAX_WEIGHT_VALUE,
            ServiceGroups.fixWeight(ServiceGroups.MAX_WEIGHT_VALUE + 1));
    }
}
