...
import org.mydotey.artemis.management.util.ServerModels;
 ...
 */
public class ServerDaoTest extends ArtemisTest {
    ...
    public void testQueryUncompletedServers() {
        final List<ServerModel> servers = Lists.newArrayList(ServerModels.newServerModel(),
            ServerModels.newServerModel());
