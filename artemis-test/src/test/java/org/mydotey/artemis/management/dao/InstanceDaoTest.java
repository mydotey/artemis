...
import org.mydotey.artemis.management.util.InstanceModels;
 ...
 */
public class InstanceDaoTest extends ArtemisTest {
    ...
    public void testQueryUncompletedInstance() {
        ...
        final List<InstanceModel> instanceModels = instanceDao.queryInstance(Constants.regionId,
    ...
    public void testQueryUncompletedInstances() {
        final List<InstanceModel> instances = Lists.newArrayList(InstanceModels.newInstanceModel(),
            InstanceModels.newInstanceModel());
