 ...
 */
public class GroupOperationDaoTest extends ArtemisTest {
    ...
    private GroupOperationModel query(GroupOperationModel groupOperation) {
        List<GroupOperationModel> groupOperationFromQuery = groupOperationDao.query("group_id = ? and operation=?",
            Lists.newArrayList(Long.toString(groupOperation.getGroupId()), groupOperation.getOperation()));
