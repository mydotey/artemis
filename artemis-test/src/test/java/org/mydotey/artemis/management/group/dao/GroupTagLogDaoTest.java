...
import org.mydotey.artemis.management.group.log.GroupTagLog;
import org.mydotey.artemis.management.group.model.GroupTagLogModel;
 ...
 */
public class GroupTagLogDaoTest extends ArtemisTest {
    ...
    public void testInsert() {
        ...
        Assert.assertTrue(
            groupTagLogDao.query("create_time >= DATE_SUB(now(), INTERVAL ? MINUTE)", "2").size() >= logs.size());
