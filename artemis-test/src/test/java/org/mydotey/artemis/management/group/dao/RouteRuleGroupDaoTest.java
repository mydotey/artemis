 ...
 */
public class RouteRuleGroupDaoTest extends ArtemisTest {
    ...
    public void testInsert() {
        for (RouteRuleGroupModel routeRuleGroup : newRouteRuleGroups()) {
            ...
            assertRouteRuleGroup(routeRuleGroup, query(routeRuleGroup));
            Integer old = routeRuleGroup.getUnreleasedWeight();
            routeRuleGroup.setUnreleasedWeight(null);
            routeRuleGroupDao.insert(routeRuleGroup);
            routeRuleGroup.setUnreleasedWeight(old);
            assertRouteRuleGroup(routeRuleGroup, query(routeRuleGroup));
        }
    }
    ...
    public void testSelect() {
        for (RouteRuleGroupModel routeRuleGroup : newRouteRuleGroups()) {
            ...
            Assert.assertEquals(1,
                routeRuleGroupDao.select(Lists.newArrayList(routeRuleGroupDao.select(filter).get(0).getId())).size());
        }
    }
