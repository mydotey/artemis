 ...
 */
public class ServiceInstanceDaoTest extends ArtemisTest {
    ...
    private ServiceInstanceModel query(ServiceInstanceModel filter, int expectedSize) {
        List<ServiceInstanceModel> newServiceInstance = serviceInstanceDao.query("service_id = ? and instance_id=?",
            Lists.newArrayList(filter.getServiceId(), filter.getInstanceId()));
