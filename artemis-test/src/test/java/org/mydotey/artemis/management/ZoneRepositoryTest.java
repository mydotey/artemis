...
import org.mydotey.artemis.management.zone.dao.ZoneOperationDaoTest;
 ...
 */
public class ZoneRepositoryTest extends ArtemisTest {
    ...
    public void testRefreshCache() {
        ...
        Assert.assertEquals(allZoneOperationsSize + zoneOperations.size(),
            zoneRepository.getAllZoneOperations(DeploymentConfig.regionId()).size());
        ...
        zoneRepository.refreshCache();
        Assert.assertEquals(allZoneOperationsSize,
            zoneRepository.getAllZoneOperations(DeploymentConfig.regionId()).size());
        for (ZoneOperationModel model : zoneOperations) {
            ZoneKey zoneKey = new ZoneKey(model.getRegionId(), model.getServiceId(), model.getZoneId());
