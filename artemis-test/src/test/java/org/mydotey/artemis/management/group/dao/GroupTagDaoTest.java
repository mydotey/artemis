 ...
 */
public class GroupTagDaoTest extends ArtemisTest {
    ...
    private GroupTagModel query(GroupTagModel GroupTag) {
        List<GroupTagModel> GroupTagFromQuery = groupTagDao.query("group_id = ? and tag=?",
            Lists.newArrayList(Long.toString(GroupTag.getGroupId()), GroupTag.getTag()));
