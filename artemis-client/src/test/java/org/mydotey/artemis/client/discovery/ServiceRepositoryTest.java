...
public class ServiceRepositoryTest {
    private final ServiceRepository _serviceRepository = new ServiceRepository(
    ...
    public void TestUpdate_Service() {
        for (int i = 0; i < 5; i++) {
            ...
            Service service2 = new Service(serviceId,
                Lists.newArrayList(Instances.newInstance(serviceId), Instances.newInstance(serviceId)), null);
