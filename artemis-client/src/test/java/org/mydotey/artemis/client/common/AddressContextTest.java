...
public class AddressContextTest {
    ...
    public void testAavilable() {
        AddressContext context = newAddressContext(StringExtension.EMPTY);
    ...
    public AddressContext newAddressContext(final String url) {
        return new AddressContext(ArtemisClientConstants.ClientId, ArtemisClientConstants.ManagerConfig, url,
            webSocketEndpoint);
    }
}
