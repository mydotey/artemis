...
public class ConditionsTest {
    ...
    public void verifyServices() {
        {
            Assert.assertFalse(
                Conditions.verifyServices(Lists.newArrayList(new Service(), new Service(Services.newServiceId()))));
        }

        {
            Assert.assertTrue(Conditions.verifyServices(
                Lists.newArrayList(new Service(Services.newServiceId()), new Service(Services.newServiceId()))));
        }
    }
}
