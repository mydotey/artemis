...
public class ServiceNodeStatus {
    ...
    public ServiceNodeStatus(ServiceNode node, String status, Boolean canServiceRegistry, Boolean canServiceDiscovery,
        Boolean allowRegistryFromOtherZone,
    ...
    public String toString() {
        return String.format("{ node: %s, status: %s, canServiceRegistry: %s, canServiceDiscovery: %s }", _node,
            _status, _canServiceRegistry,
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equal(_node, nodeStatus._node) && Objects.equal(_status, nodeStatus._status)
            && Objects.equal(_canServiceRegistry, nodeStatus._canServiceRegistry)
            && Objects.equal(_canServiceDiscovery, nodeStatus._canServiceDiscovery);
    }
